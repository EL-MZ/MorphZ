...
MPLCONFIGDIR="${MPLCONFIGDIR:-$REPO_ROOT/docs/_build/matplotlib}"
mkdir -p "$MPLCONFIGDIR"
PYTHONPATH="$REPO_ROOT/src${PYTHONPATH:+:$PYTHONPATH}" MPLCONFIGDIR="$MPLCONFIGDIR" "$JUPYTER_BOOK_BIN" build "$REPO_ROOT/docs"
